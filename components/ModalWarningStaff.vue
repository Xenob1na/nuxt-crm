<template>
    <div id="Modal"
        ...
        <div class="bg-white w-full max-w-[500px] rounded-lg text-white border border-gray-500 p-2">
            <button class="flex justify-between bg-white w-full p-3" @click="isModalWarningStaff = false">
                <p class="text-red-500 font-bold text-[16px]">Внимание</p>
                <Icon name="mdi:close" size="25" color="black" />
            </button>

            <div class="text-center">
                <p class="text-red-500 font-bold text-[20px] p-3">Вы удалили сотрудника</p>
            </div>
        </div>
    </div>
</template>
