<template>
    <div class="max-w-[660px] mx-auto mt-[120px]">
        <div class="bg-white py-6 sm:py-8 lg:py-12 rounded-[10px]">
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                ...
                <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-8 lg:text-3xl">Регистрация</h2>
                <form class="mx-auto max-w-lg rounded-lg">
                    <div class="flex flex-col gap-4 p-4 md:p-8">
                        ...
                        <button
                            class="block rounded-lg bg-[#605BFF] px-8 py-4 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 md:text-base">Регистрация</button>

                        <div>
                            <nuxt-link to="/login" class="text-[#605BFF] hover:text-[#4b46c5]">If you have an account, log in to it</nuxt-link>
                        </div>
                    </div>
                </form>
            </div>
