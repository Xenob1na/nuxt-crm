                    ...
                    <form class="mx-auto  rounded-lg" @click.prevent="">
                        <div class="flex flex-col gap-4 p-4 md:p-8">
                            <div>
                                ...
                                <input name="fullName" v-model="form.full_name_customer"
                            ...
                            <div>
                                ...
                                <input name="adress" v-model="form.address"
                                    class="w-full rounded border bg-[#F7F7F8] px-4 py-3 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
                            </div>
                            ...
                            <button
                                class="block rounded-lg bg-[#605BFF] px-8 py-4 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 md:text-base" @click="submitCustomer">Сохранить</button>
                        </div>
                    </form>
